...
def stresnet(c_conf=(3, 2, 81), p_conf=(3, 2, 81), t_conf=(3, 2, 81),
             ...
             external_dim1=None, nb_residual_unit=3, nb_edge_residual_unit=3):
    '''
    ...
    if external_dim1 is not None and external_dim1 > 0:
        ...
        main_output1 = Activation('tanh', name='node_logits')(main_output1)
        ...
        main_output2 = Activation('tanh', name='edge_logits')(main_output2)
