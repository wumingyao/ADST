    ...
    for conf1 in [c1_conf, p1_conf, t1_conf]:
        if conf1 is not None:
            ...
            conv11 = Convolution2D(
                filters=64, kernel_size=5, border_mode="same")(input1)
            # [nb_residual_unit] Residual Units
            residual_output1 = ResUnits(_residual_unit_2d, se_block2d, nb_filter=64, repetations=nb_residual_unit)(
                conv11)
            # Conv2
            activation1 = Activation('relu')(residual_output1)
            conv21 = Convolution2D(
                filters=1, kernel_size=3, border_mode="same")(activation1)
            conv21 = Reshape((nb_stations, nb_stations))(conv21)
